        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <select className="form-select" aria-label="Default select example">
                ...
                <option value="48-arab">48-Arab</option>
              </select>
            </div>
            <fieldset className="form-group">
              <label className="col-form-label col-sm-1 pt-0">Role</label>
              <div className="form-check form-check-inline gender" >
                <input className="form-check-input" type="radio" name="role" id="gridRadios1" onChange={handleChange} value="Admin" checked={user.role === 'Admin'} />
                <label className="form-check-label" htmlFor="gridRadios1">Admin</label>
              </div>
              <div className="form-check form-check-inline gender female ">
                <input className="form-check-input" type="radio" name="role" id="gridRadios2" onChange={handleChange} value="User" checked={user.role === 'User'} />
